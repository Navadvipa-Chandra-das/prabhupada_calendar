...
class Класс_О_программе : VerticalLayout
{
  this( string ID )
  {
    ...
    гл_Версия.addChild( new TextWidget( "Номер версии"c, "3.0.0"d ).styleId( "POPUP_MENU" ) );
...
class Класс_Хитрый_накопитель {
  ...
  void В_копилку( string строка, Тип_строки вид_строки )
  {
    if ( _печатать_пустые_дни ) {
      ...
      if ( /*( _будь_на_чеку_месяц_начался && вид_строки == Тип_строки.День ) ||*/
          !( вид_строки == Тип_строки.Праздник || вид_строки == Тип_строки.Окончание_поста ) )
