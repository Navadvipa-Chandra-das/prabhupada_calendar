...
class Класс_О_программе : VerticalLayout
{
  this( string ID )
  {
    ...
    гл_Версия.addChild( new TextWidget( "Номер версии"c, "1.0.0"d ).styleId( "POPUP_MENU" ) );
...
{
  TabWidget _Закладки;
  Класс_Конвертилка_переводчик _ТаблицаКонвертилка;
  ...
  this( string ID ) {
    ...
    _ТаблицаКонвертилка = new Класс_Конвертилка_переводчик( "ТаблицаКонвертилка"c );
    ...
    _Закладки.addTab( _ТаблицаКонвертилка, "ЗАКЛАДКА_КОНВЕРТИЛКА_ПЕРЕВОДЧИК"c );
    ...
    _ТаблицаКонвертилка._Выпадающий_список_Наряд_программы.selectedItemIndex = 1;
